...
st.markdown(
    """
    Este dashboard interativo apresenta uma análise abrangente da evolução da pandemia de COVID-19, com base nos dados públicos disponibilizados pelo *The New York Times* ([GitHub - NYT COVID-19 Data](https://github.com/nytimes/covid-19-data)).
